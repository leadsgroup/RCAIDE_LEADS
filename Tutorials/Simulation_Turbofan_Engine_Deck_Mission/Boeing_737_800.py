'''
  ...
  Same Boeing 737-800 as Simulation_Turbofan_Transonic_Aircraft_5000nmi_Mission --
  see that tutorial for a full walkthrough of vehicle_setup(). The only difference
  here: the starboard/port turbofans load Boeing_737_800_Engine_Deck.xlsx (an
  already-built deck sitting next to this file) into turbofan.surrogate instead of
  using RCAIDE's analytical turbofan cycle model -- the same Turbofan_Surrogate
  mechanism used to import a real GasTurb/test-stand deck.
