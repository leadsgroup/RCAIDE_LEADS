...
def vehicle_setup():
    ...
    vehicle.tag                                       = 'BWB' 
    vehicle.mass_properties.max_takeoff               = 125000.  
    ...
    flight_controls.origin            = [[3.5,0,0]]
