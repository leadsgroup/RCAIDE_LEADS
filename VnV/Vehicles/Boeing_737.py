...
def vehicle_setup(): 
    ...
    turbofan.identical_propulsors                  = True
    ...
    # sized so the off-design sea-level static thrust matches the CFM56-7B26 takeoff rating,
    # 116.99 kN (EASA TCDS E.004, Issue 07)
    turbofan.design_thrust                         = 34346.1 * Units.N
