...
def main():
    ...
    convetional_cruise_CL_truth      = 0.6871928721745746
    electric_cruise_CL_truth         = 0.7972017270830801
    series_hybrid_cruise_CL_truth    = 0.6935479692037455
    parallel_hybrid_cruise_CL_truth  = 0.6931587531177575
