...
def main():
    ...
    convetional_cruise_CL_truth      = 0.6874437586680276
    electric_cruise_CL_truth         = 0.7972017270830627
    series_hybrid_cruise_CL_truth    = 0.6935479687807559
    parallel_hybrid_cruise_CL_truth  = 0.6934133566440289
