...
def main():
    ...
    convetional_cruise_CL_truth      = 0.6917775683899845
    electric_cruise_CL_truth         = 0.6977019408399342
    series_hybrid_cruise_CL_truth    = 0.6975024069183404
    parallel_hybrid_cruise_CL_truth  = 0.6976545006123366
