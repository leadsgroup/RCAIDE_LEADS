...
def main():   
    ...
    marker_size           = 5   
    mdot_H2_true          = [3.1979336247376623e-07,8.466169713191963e-07]
    ...
    for i in range(len(fuel_cell_tpye)):
        ...
        fuel_cell_tag = list(vehicle.networks.electric.converters.keys())[0]
        mdot_H2       = results.segments[0].conditions.energy.converters[fuel_cell_tag].H2_mass_flow_rate
