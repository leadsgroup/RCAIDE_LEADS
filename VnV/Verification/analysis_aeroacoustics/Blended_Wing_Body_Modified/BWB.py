...
def vehicle_setup():  
    airfoil_file_path =  '/Users/siripunn/Desktop/LEADS_WORK/LEADS_Research/RCAIDE_LEADS/VnV/Vehicles/Airfoils/'
    ...
    #------------------------------------------------------------------------------------------------------------------------------------ 
    # Propulsor 1 (Port Side, Wing Mounted)
    #------------------------------------------------------------------------------------------------------------------------------------         
