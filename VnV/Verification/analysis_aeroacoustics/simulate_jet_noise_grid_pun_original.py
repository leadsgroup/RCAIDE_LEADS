...
from RCAIDE.Library.Methods.Aeroacoustics.Semi_Empirical.Propulsion.Engine_Noise.vectorized_mixed_noise_components_pun_original import compute_landing_gear_noise
from RCAIDE.Library.Methods.Aeroacoustics.Semi_Empirical.Propulsion.Engine_Noise.vectorized_mixed_noise_components_pun_original import flap_noise_model
from RCAIDE.Library.Methods.Aeroacoustics.Semi_Empirical.Propulsion.Engine_Noise.vectorized_mixed_noise_components_pun_original import slat_noise
from RCAIDE.Library.Methods.Aeroacoustics.Semi_Empirical.Propulsion.Engine_Noise.vectorized_mixed_noise_components_pun_original import compute_fan_noise
from RCAIDE.Library.Methods.Aeroacoustics.Semi_Empirical.Propulsion.Engine_Noise.vectorized_mixed_noise_components_pun_original import compute_core_noise
from RCAIDE.Library.Methods.Aeroacoustics.Semi_Empirical.Propulsion.Engine_Noise.compute_jet_noise_new_pun_original import compute_jet_noise_new
...
def simulate_vehicle_noise_grid(vehicle,path,frequency_range,grid_location,grid_dimensions,receptor_alt_MSL,fast = True,plot = True): 
    ...
    **Definitions**
    ...
    np.savez('b737_high_res_footprint_pun_original.npz', 
                        longitude=x, 
                        latitude=y, 
                        sel_dBA=z)
