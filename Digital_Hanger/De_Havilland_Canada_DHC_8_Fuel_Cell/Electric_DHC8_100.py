...
def vehicle_setup(vehicle_name = 'De_Havilland_DHC8-100') :
    ...
    vehicle.mass_properties.center_of_gravity      = [[9.94,0,1.175]] #[[9.077, 0, 0]]  #[[10.419, 0, 3.0]] 
    ...
    bat_module.geometrtic_configuration.parallel_count           = 125
    ...
    propeller.hub_radius                             = .1
    propeller.cruise.design_freestream_velocity      = 250 * Units.kts  
...
def base_analysis(vehicle):
    ...
    weights.settings.weight_correction_additions.empty.propulsion.nacelle = 498.0
...
def mission_setup(analyses):
    ...
    segment.velocity_end             = 130.0 * Units['knots']
    ...
    segment.distance                                      = 124 * Units.nmi   
