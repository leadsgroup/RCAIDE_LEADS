...
modules = [ 
    ...
    'Tests/network_fuel_cell/hydrogen_fuel_cell_aircraft_test.py', 
    ...
    'Tests/performance/aircraft_aerodynamics_test.py', 
    'Tests/performance/noise_certification_test.py', 
