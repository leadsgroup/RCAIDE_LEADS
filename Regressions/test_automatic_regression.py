...
modules = [
    ...
    'Tests/mission_segments/transition_segment_test.py', #TO DO 
    ...
    'Tests/network_hybrid/hybrid_network_test.py', #TO DO 
    ...
    'Tests/propulsion/propeller_non_uniform_inflow.py',   #TO DO  
    'Tests/propulsion/propeller_wing_interaction_test.py',  #TO DO  
