...
def vehicle_setup(): 
    ...
    main_gear.tire_diameter                  = 30.0 * Units.inches
    main_gear.rim_diameter                   = 15.0 * Units.inches
    main_gear.tire_width                     = 9.5  * Units.inches
    main_gear.strut_length                   = 4.0  * Units.ft
    main_gear.origin                         = [[9.5, 2.2, 0.0]]
    main_gear.units                          = 2
    main_gear.wheels                         = 2
