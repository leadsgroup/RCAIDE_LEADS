...
def main():
    ...
    #MOI_cargo,  cargo_mass =  compute_cuboid_moment_of_inertia([[34, 0, 0]], vehicle.mass_properties.payload, 40, 4, 2, center_of_gravity=CG_location)
...
def vehicle_setup(): 
    ...
    vehicle.mass_properties.center_of_gravity         = [[32.00, 0, 0]] # CHANGE??
