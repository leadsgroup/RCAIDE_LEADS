...
def vehicle_setup():
    ...
    nac_segment.percent_z_location = 0.00833
    ...
    nac_segment.percent_z_location = 0.03484
    nac_segment.height             = 0.0
    nac_segment.width              = 0.0
    nacelle.append_segment(nac_segment)  
    ...
    nacelle_2.origin   = [[3.361,-2.25,1.0]]   
   ...
   # ########################################################  Energy Network  #########################################################  
    ...
    propeller.cruise.design_angular_velocity         = 2700.0 * Units.rpm  
    propeller.cruise.design_altitude                 = 2500*Units.ft  
    propeller.cruise.design_thrust                   = 2500.0 * Units.N
    
    propeller.origin                                 =  [[3.9,2.25,1.0]]
    ospath                                           = os.path.abspath(__file__)
    separator                                        = os.path.sep
    ...
    airfoil.polar_files                              =[ 'xf-naca4412-il-50000.txt',
                                                        'xf-naca4412-il-100000.txt',
                                                        'xf-naca4412-il-200000.txt',
                                                        'xf-naca4412-il-500000.txt',
                                                        'xf-naca4412-il-1000000.txt']   
    ...
    port_propulsor.origin =[[3.36,-2.25,1.0]]  
    port_propulsor.tag                                 = "port_propulsor" 
    port_propulsor.electronic_speed_controller.origin  = [[4.75,-2.25,1.0]]  
    port_propulsor.electronic_speed_controller.tag     = 'port_propulsor_esc'  
    port_propulsor.rotor.tag                           = 'port_propulsor_propeller' 
    port_propulsor.rotor.origin                        = [[3.9,-2.25,1.0]]
    port_propulsor.motor.tag                           ='port_propulsor_motor' 
    port_propulsor.motor.origin                        =[[5.0,-2.25,1.0]]  
...
def mission_setup(analyses):   
    ...
    segment.altitude_end                                  = 6000 * Units.feet 
    ...
    segment.altitude                                      = 6000 * Units.feet
    segment.air_speed                                     = 150 * Units.knots 
    segment.distance                                      = 70. * Units.nautical_mile  
    ...
    segment.air_speed_start                               = 100 * Units.knots 
    segment.air_speed_end                                 = 90 * Units.knots  
