...
def parallel_hybrid_electric_ATR_72(solver_type = "optimize",solver_objective=None,plot_results=True): 
...
def vehicle_setup():
    ...
    starboard_propulsor.design_altitude              = 15000. * Units.feet                                    # [-]         Design Altitude 
...
def mission_setup(analyses,solver_type,solver_objective):
    ...
    segment.velocity_start                                   = 115 * Units.kts
    segment.velocity_end                                     = 125 * Units.kts
    segment.friction_coefficient                             = 0.04   
    segment.throttle                                         = 0.8    
    segment.hybrid_power_split_ratio                         = -.1
    segment.battery_fuel_cell_power_split_ratio              = 0.5    
    ...
    segment.air_speed_end                                 = 140 * Units.kts
    ...
    segment.altitude_end                                  = 500.0 * Units.feet
    segment.air_speed_end                                 = 125 * Units.kts
    ...
    segment.air_speed_end                                 = 115 * Units.kts
    ...
    segment.tag = "Landing"   
    segment.analyses.extend( analyses.base)  
    segment.velocity_end                                                  = 10 * Units.kts
...
if __name__ == '__main__': 
    parallel_hybrid_electric_ATR_72()    
    plt.show()