...
class Vortex_Lattice_Method(Aerodynamics):
    ...
    def __defaults__(self):
        ...
        self.training                                               = Data()
        self.training.angle_of_attack                               = np.array([5.0, 8.0, 12., 45., 75.]) * Units.deg 
        self.training.Mach                                          = np.array([0.5,  0.65 , 0.85 , 0.9, 1.3, 1.35 , 1.5 , 2.0, 2.25 , 2.5  , 3.5])             
    ...
    def initialize(self, vehicle, aerostructural_analyses=None): 
        ...
        if use_surrogate == True: 
            ...
            # build surrogate
            build_VLM_surrogates(self, vehicle,aerostructural_analyses)        
