# RCAIDE/Framework/Analyses/Aeroacoustics/Correlation_Buildup.py
# 
# 
...
# RCAIDE Imports
import  RCAIDE
from RCAIDE.Library.Methods.Aeroacoustics.Correlation_Buildup.Airframe.airframe_noise         import airframe_noise
from RCAIDE.Library.Methods.Aeroacoustics.Correlation_Buildup.Turbofan.turbofan_engine_noise  import turbofan_engine_noise   
...
#  Correlation_Buildup
# ---------------------------------------------------------------------------------------------------------------------- 
class Correlation_Buildup(Aeroacoustics): 
