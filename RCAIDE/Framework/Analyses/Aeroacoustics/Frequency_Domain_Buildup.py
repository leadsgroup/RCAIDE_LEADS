# RCAIDE/Framework/Analyses/Aeroacoustics/Frequency_Domain_Buildup.py
# 
# 
...
from RCAIDE.Library.Methods.Aeroacoustics.Frequency_Domain_Buildup.Rotor.compute_rotor_noise  import compute_rotor_noise 
...
# ----------------------------------------------------------------------------------------------------------------------
class Frequency_Domain_Buildup(Aeroacoustics):
