...
class Results(Conditions):
    ...
    def __defaults__(self):
        ...
        # Compound control surfaces: one physical hinge responding to two independent trim
        # channels (see RCAIDE.Library.Methods.Aerodynamics.Vortex_Lattice_Method.control_surface_registry).
        # `deflection` carries the primary (symmetric) command, `secondary_deflection` the
        # secondary (antisymmetric) command.
