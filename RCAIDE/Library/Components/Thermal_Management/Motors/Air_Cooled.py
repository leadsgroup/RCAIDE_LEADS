...
from RCAIDE.Library.Methods.Thermal_Management.Motors.Air_Cooled import append_air_cooled_conditions, air_cooled_performance
...
class Air_Cooled(Component):
    ...
    **Definitions**
    ...
    def compute_thermal_performance(self, battery, bus, coolant_line, Q_heat_gen, T_cell, state, delta_t, t_idx): 
        ...
        """
        T_motor = air_cooled_performance(self, battery, bus, coolant_line, 
