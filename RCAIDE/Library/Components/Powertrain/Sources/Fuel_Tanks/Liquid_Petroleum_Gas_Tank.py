# RCAIDE/Library/Components/Powertrain/Energy/Sources/Fuel_Tanks/Liquid_Petroleum_Gas_Tank.py
# 
...
# ---------------------------------------------------------------------------------------------------------------------    
class Liquid_Petroleum_Gas_Tank(Non_Integral_Tank):
    """
    A class representing a non-integral liquid petroleum gas (LPG) fuel tank.  
    Attributes
    ----------
    tag : str
    ...
    **Definitions**
    ...
    def __defaults__(self):
        ...
        None  
        """
        self.tag                           = 'Liquid_Petroleum_Gas     _Tank'
        self.fuel                          = RCAIDE.Library.Attributes.Propellants.Liquid_Petroleum_Gas()
        self.material                      = None
