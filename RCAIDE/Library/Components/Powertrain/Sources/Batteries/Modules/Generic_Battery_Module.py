# RCAIDE/Library/Components/Powertrain/Powertrain/Sources/Batteries/Modules/Generic_Battery_Module.py
# 
# 
...
from RCAIDE.Library.Methods.Powertrain.Sources.Batteries.Common import append_battery_conditions, append_battery_segment_conditions
# ----------------------------------------------------------------------------------------------------------------------
#  Battery
# ----------------------------------------------------------------------------------------------------------------------      
class Generic_Battery_Module(Source):
    ...
    **Definitions**
    ...
    def append_operating_conditions(self,battery,segment):  
        """
        ...
        """
        append_battery_conditions(self,battery,segment)
 
        return

    
    def append_segment_conditions(self,battery,segment):
        """
        ...
        segment : Segment
            Flight segment data
        """
        append_battery_segment_conditions(self,battery,segment) 
        return     