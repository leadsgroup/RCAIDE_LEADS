...
class Heater(Converter):
    ...
    def __defaults__(self):
        ...
        self.design_power        = None   # max thermal power [W]; None -> tank sizes a default cap (see compute_cryogenic_tank_performance)
        self.externally_powered  = True   # ground cart supplies it during ground_operations segments; irrelevant in flight
