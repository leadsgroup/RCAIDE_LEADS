...
class Combustor(Converter):
    ...
    **Definitions**
    ...
    def __defaults__(self):
        ...
        self.N_PZ                                    = 41             # [-] Number of PSR in the Primary Zone
        ...
        self.f_SM                                    = 0.2            # [-] Slow mode fraction
        self.l_SA_SM                                 = 0.4            # [-] Secondary air length fraction (of L_SZ) in slow mode
        self.l_SA_FM                                 = 0.1           # [-] Secondary air length fraction (of L_SZ) in fast mode
        ...
        self.joint_mixing_fraction                   = 0.8            # [-] Joint mixing fraction
        self.design_equivalence_ratio_SZ             = 0.54            # [-] Design Equivalence Ratio in Secondary Zone at Maximum Throttle
        self.air_mass_flow_rate_take_off             = 56.8            # [kg/s] Air mass flow rate at take-off
        self.fuel_to_air_ratio_take_off              = 0.0226          # [-] Fuel to air ratio at take-off
