...
class Rotor(Component):
    ...
    **Definitions**
    ...
    def append_operating_conditions(rotor,segment,energy_conditions,aeroacoustics_conditions=None): 
        append_rotor_conditions(rotor,segment,energy_conditions,aeroacoustics_conditions)
        return        
