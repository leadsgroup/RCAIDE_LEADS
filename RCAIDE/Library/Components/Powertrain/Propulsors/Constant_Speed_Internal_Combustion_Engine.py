...
class Constant_Speed_Internal_Combustion_Engine(Propulsor):
    ...
    **Definitions**
    ...
    def compute_performance(self,state,center_of_gravity = [[0, 0, 0]]):
        thrust,moment,Power, stored_results_flag,stored_propulsor_tag =  compute_constant_speed_internal_combustion_engine_performance(self,state,center_of_gravity)
        return thrust,moment,Power,stored_results_flag,stored_propulsor_tag
    
    def reuse_stored_data(ICE_cs_prop, state,network,stored_propulsor_tag = None,center_of_gravity = [[0, 0, 0]]):
        thrust,moment,Power  = reuse_stored_constant_speed_internal_combustion_engine_data(ICE_cs_prop,state,network,stored_propulsor_tag,center_of_gravity)
