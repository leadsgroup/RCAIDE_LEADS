...
class Turbofan(Propulsor):
    ...
    **Definitions**
    ...
    def compute_performance(self,state, network, center_of_gravity = [[0, 0, 0]]):
        ...
        """
        thrust,moment,power_mech,power_elec,power_hydr,power_therm,stored_results_flag,stored_propulsor_tag =  compute_turbofan_performance(self,state, network, center_of_gravity)
    ...
    def reuse_stored_data(turbofan,state,network,stored_propulsor_tag = None,center_of_gravity = [[0, 0, 0]]):
        ...
        """
        thrust,moment,power_mech,power_elec,power_hydr,power_therm  = reuse_stored_turbofan_data(turbofan,state,network,stored_propulsor_tag,center_of_gravity)
