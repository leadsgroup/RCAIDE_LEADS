            ...
            for fuel_tank in fuel_line.fuel_tanks:   
                if fuel_tank.wing_tag != None:
                    ...
                    if issubclass(type(fuel_tank), RCAIDE.Library.Components.Powertrain.Sources.Fuel_Tanks.Non_Integral_Tank):
                        if issubclass(type(fuel_tank), (RCAIDE.Library.Components.Powertrain.Sources.Fuel_Tanks.Liquid_Hydrogen_Tank,\
                                                         RCAIDE.Library.Components.Powertrain.Sources.Fuel_Tanks.Liquid_Natural_Gas_Tank)) and fuel_tank.geometry_type == 'conformal' and fuel_tank.bwb_aft_tank:
                        ...
                        elif issubclass(type(fuel_tank), (RCAIDE.Library.Components.Powertrain.Sources.Fuel_Tanks.Liquid_Hydrogen_Tank,
                                                         RCAIDE.Library.Components.Powertrain.Sources.Fuel_Tanks.Liquid_Natural_Gas_Tank)) \
                                                        and fuel_tank.geometry_type == 'conformal':
