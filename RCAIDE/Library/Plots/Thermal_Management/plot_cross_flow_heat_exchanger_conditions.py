...
def plot_cross_flow_heat_exchanger_conditions(cross_flow_hex, results, coolant_line,
    ...
    results : Results
        RCAIDE results data structure containing:
            - segments[i].conditions.energy.distributors[coolant_line.tag][cross_flow_hex.tag]
            ...
            if isinstance(source, RCAIDE.Library.Components.Powertrain.Sources.Batteries.Battery_Pack):
                ...
                if b_i == 0 or source.identical_sources == False:
                    for i in range(len(results.segments)): 
                        ...
                        cross_flow_hex_conditions  = results.segments[i].conditions.energy.distributors[coolant_line.tag][cross_flow_hex.tag]
