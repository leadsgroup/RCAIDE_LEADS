...
def FEA(conditions,VLM_results,VD,settings,geometry):
    ...
    for ti in range(n_cpts):
        ...
        for wing in geometry.wings.values():
            ...
            T_all           = compute_3d_transformation_matrix(VD_structural_wing.sweep_mid_elems, VD_structural_wing.dihedral_elems, twist_elems, num_elements)
            ...
            structural_results[wing.tag].deflection[ti,:,0]     = u_full[0::6]  
            structural_results[wing.tag].deflection[ti,:,2]     = u_full[2::6]  
