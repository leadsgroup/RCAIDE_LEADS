# RCAIDE/Methods/Aeroacoustics/Frequency_Domain_Buildup/Rotor/compute_rotor_noise.py
# 
# 
...
from RCAIDE.Library.Methods.Aeroacoustics.Frequency_Domain_Buildup.Rotor.harmonic_noise_point      import harmonic_noise_point
from RCAIDE.Library.Methods.Aeroacoustics.Frequency_Domain_Buildup.Rotor.harmonic_noise_line       import harmonic_noise_line
from RCAIDE.Library.Methods.Aeroacoustics.Frequency_Domain_Buildup.Rotor.harmonic_noise_plane      import harmonic_noise_plane 
from RCAIDE.Library.Methods.Aeroacoustics.Frequency_Domain_Buildup.Rotor.broadband_noise           import broadband_noise
...
def compute_rotor_noise(microphone_locations,rotor,segment,settings, rotor_index = 0, previous_rotor_tag = None, identical_propulsors=True):
    ...
    for cpt in range(num_cpt): 
        ...
        if settings.fidelity == 'plane_source': 
            ...
            harmonic_noise_plane(harmonics_blade,harmonics_load,conditions,coordinates,rotor,settings,aeroacoustics,cpt)
        elif settings.fidelity == 'line_source': 
            harmonic_noise_line(harmonics_blade,harmonics_load,conditions,coordinates,rotor,settings,aeroacoustics,cpt)
        else:
            harmonic_noise_point(harmonics_blade,harmonics_load,conditions,coordinates,rotor,settings,aeroacoustics,cpt) 
