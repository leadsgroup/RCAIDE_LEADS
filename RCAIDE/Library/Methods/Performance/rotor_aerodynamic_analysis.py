...
def rotor_aerodynamic_analysis(rotor,
    ...
    operating_state = setup_operating_conditions(rotor, altitude = altitude,velocity_range=velocity_range, angle_of_attack=angle_of_attack, temperature_deviation=0)
