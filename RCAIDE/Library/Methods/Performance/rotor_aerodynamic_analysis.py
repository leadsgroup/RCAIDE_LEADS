...
def rotor_aerodynamic_analysis(rotor,
    ...
    rotor.assigned_distributors = [[distributor.tag]]
    operating_state = setup_operating_conditions(rotor,distributor,velocity_range=velocity_range, altitude = altitude, angle_of_attack=angle_of_attack, temperature_deviation=0)
