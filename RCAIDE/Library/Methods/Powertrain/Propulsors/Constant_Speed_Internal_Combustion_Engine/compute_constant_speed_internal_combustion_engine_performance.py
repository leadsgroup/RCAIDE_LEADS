...
def compute_constant_speed_internal_combustion_engine_performance(propulsor,state,fuel_line=None,bus=None,center_of_gravity= [[0.0, 0.0,0.0]]):   
    ...
    ----------
    propulsor : dict
        constant speed internal combustion engine compoment   
    state : dict
    ...
    total_thrust: array_like
        thrust of constant speed internal combustion engine [N]
    total_momnet: array_like
        moment of constant speed internal combustion engine  [Nm]
    total_mechanical_power: array_like
        mechanical power generated by constant speed internal combustion engine [W] 
    total_electrical_power: array_like
        electrical power generated by constant speed internal combustion engine [W] 
    stored_results_flag: boolean
        boolean for stored results [-]     
    stored_propulsor_tag; string
        name of constant speed internal combustion engine with stored results [-] 
    ''' 
