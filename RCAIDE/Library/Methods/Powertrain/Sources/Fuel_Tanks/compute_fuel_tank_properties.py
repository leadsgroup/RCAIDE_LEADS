...
def compute_fuel_tank_properties(tank,state,distributor):
    ...
    mass_flow_rate                                 = tank_conditions.fuel_flow_split_ratio*distributor_conditions.fuel_mass_flow_rate + tank_conditions.boil_off_flow_rate +  tank_conditions.secondary_mass_flow_rate             
