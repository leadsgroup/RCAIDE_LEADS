...
def append_system_segment_conditions(system, segment): 
    ...
    energy_conditions.systems[system.tag].inputs.power.propulsive[:,0]    = 0.0
    energy_conditions.systems[system.tag].inputs.power.mechanical[:,0]    = 0.0 
    energy_conditions.systems[system.tag].inputs.power.electrical[:,0]    = 0.0 
    energy_conditions.systems[system.tag].inputs.power.chemical[:,0]      = 0.0
    energy_conditions.systems[system.tag].inputs.power.pneumatic[:,0]     = 0.0 
    energy_conditions.systems[system.tag].inputs.power.hydraulic[:,0]     = 0.0 
    energy_conditions.systems[system.tag].inputs.power.thermal[:,0]       = 0.0 
    energy_conditions.systems[system.tag].outputs.power.propulsive[:,0]   = 0.0
    energy_conditions.systems[system.tag].outputs.power.mechanical[:,0]   = 0.0   
    energy_conditions.systems[system.tag].outputs.power.electrical[:,0]   = 0.0 
    energy_conditions.systems[system.tag].outputs.power.chemical[:,0]     = 0.0
    energy_conditions.systems[system.tag].outputs.power.pneumatic[:,0]    = 0.0   
    energy_conditions.systems[system.tag].outputs.power.hydraulic[:,0]    = 0.0   
    energy_conditions.systems[system.tag].outputs.power.thermal[:,0]      = 0.0  