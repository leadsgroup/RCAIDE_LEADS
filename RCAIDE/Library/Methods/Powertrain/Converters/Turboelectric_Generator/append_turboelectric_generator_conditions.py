...
def append_turboelectric_generator_conditions(turboelectric_generator,segment):  
    ...
    segment.state.conditions.energy.converters[turboelectric_generator.tag].power.inputs.propulsive        = 0 * ones_row(1)
    segment.state.conditions.energy.converters[turboelectric_generator.tag].power.inputs.mechanical        = 0 * ones_row(1)
    segment.state.conditions.energy.converters[turboelectric_generator.tag].power.inputs.electrical        = 0 * ones_row(1)
    segment.state.conditions.energy.converters[turboelectric_generator.tag].power.inputs.chemical          = 0 * ones_row(1)
    segment.state.conditions.energy.converters[turboelectric_generator.tag].power.inputs.pneumatic         = 0 * ones_row(1)
    segment.state.conditions.energy.converters[turboelectric_generator.tag].power.inputs.hydraulic         = 0 * ones_row(1)
    segment.state.conditions.energy.converters[turboelectric_generator.tag].power.inputs.thermal           = 0 * ones_row(1)
    segment.state.conditions.energy.converters[turboelectric_generator.tag].power.outputs.propulsive       = 0 * ones_row(1)
    segment.state.conditions.energy.converters[turboelectric_generator.tag].power.outputs.mechanical       = 0 * ones_row(1)
    segment.state.conditions.energy.converters[turboelectric_generator.tag].power.outputs.electrical       = 0 * ones_row(1)
    segment.state.conditions.energy.converters[turboelectric_generator.tag].power.outputs.chemical         = 0 * ones_row(1)
    segment.state.conditions.energy.converters[turboelectric_generator.tag].power.outputs.pneumatic        = 0 * ones_row(1)
    segment.state.conditions.energy.converters[turboelectric_generator.tag].power.outputs.hydraulic        = 0 * ones_row(1)
    segment.state.conditions.energy.converters[turboelectric_generator.tag].power.outputs.thermal          = 0 * ones_row(1)
