...
def design_ducted_fan(ducted_fan, new_regression_results = False, keep_files = True): 
    ...
    **Major Assumptions**
    ...
    if ducted_fan.fidelity == 'Rankine_Froude_Momentum_Theory':
        ...
        power              = clean_data(raw_data.power.propulsive,mach,tip_mach,altitude,raw_data.converged_solution)
        ...
        surrogates.power               = Data()
        surrogates.power.propulsive    = interpolate.RegularGridInterpolator((mach,tip_mach,altitude),power                ,method = 'linear',   bounds_error=False, fill_value=None)
