...
class Unidirectional_Carbon_Fiber(Solid):
    ...
    thermal_conductivity : float
        Through-thickness (transverse) thermal conductivity in W/(m*K) (0.5)
    ...
    **Definitions**
    ...
    References
    ----------
    [1] MatWeb. (n.d.). Overview of materials for Epoxy/Carbon Fiber Composite. Overview 
        of materials for epoxy/carbon fiber composite. 
        https://www.matweb.com/search/datasheet.aspx?matguid=39e40851fc164b6c9bda29d798bf3726
    [2] Through-thickness conduction is matrix-dominated (much lower than the in-plane,
        fiber-dominated value) at ~0.5 W/(m*K) for PAN-based carbon fiber composites, per
        analysis of transverse thermal conductivity in carbon fiber composites, PMC.
        https://pmc.ncbi.nlm.nih.gov/articles/PMC10826174/
    """
    ...
    def __defaults__(self):
        ...
        self.thermal_conductivity       = 0.5       # W/(m*K)
