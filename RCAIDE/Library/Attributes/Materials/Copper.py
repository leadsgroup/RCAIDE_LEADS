...
class Copper(Solid):
    ...
    def compute_thermal_conductivity(self, temperature): 
        ...
        conductivity_func   = CubicSpline(temperatures, conductivities,extrapolate=True) 
        conductivity = conductivity_func(temperature)       
        return conductivity
        


    # lookup table and interpolator for estimating the electrical conductivity of copper at cryogenic temperatures.
    def compute_electrical_conductivity(self, temperature): 
    ...
    def compute_electrical_resistivity(self, temperature):
        
        conductivity = self.compute_electrical_conductivity(temperature)
